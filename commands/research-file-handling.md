...
argument-hint: "[ruta de otro proyecto propio a inspeccionar | nombre del proveedor a investigar]"
---
...
**Aprendiz** (`references/learner.md`, a dónde promueve lo que generaliza). Léelos antes de
operar. No inventa ningún límite ni proveedor: los investiga y, si no hay estándar, los
pregunta.
...
2. **Consulta la documentación oficial vigente del proveedor** en uso o candidato (S3,
   ...
   Cítala con versión/fecha — nunca de memoria (`evidence-protocol.md`). Si no hay acceso
   a red para consultarla, decláralo como hueco explícito; no se inventa un límite.
